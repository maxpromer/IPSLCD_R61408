...
/*************************IIC**************************************/
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC , ENABLE);
	...
	GPIO_InitStructure.GPIO_Pin = FT_SCL_Pin;  //PC5  
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
	GPIO_Init(GPIOC, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin =  FT_SDA_Pin; //PB12
...
//	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = TchPre;	//抢占优先级2， 
//	NVIC_InitStructure.NVIC_IRQChannelSubPriority = TchSub;					//子优先级3
